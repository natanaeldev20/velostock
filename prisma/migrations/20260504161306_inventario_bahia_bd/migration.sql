...
*/
-- CreateEnum
CREATE TYPE "ActionType" AS ENUM ('CREAR', 'ACTUALIZAR', 'ELIMINAR', 'ACTIVAR', 'DESACTIVAR');

-- CreateEnum
CREATE TYPE "Entity" AS ENUM ('USUARIO', 'PRODUCTO', 'CATEGORIA', 'MOVIMIENTO_INVENTARIO');
